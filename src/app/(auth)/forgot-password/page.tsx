              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="you@example.com" className="rounded-xl border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/50 dark:text-slate-100" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
